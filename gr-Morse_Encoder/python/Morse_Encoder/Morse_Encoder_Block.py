...
class WSPR(gr.sync_block):
    ...
    def generateSymbols(self):
        ...
        if self.debug != 0: 
            ...
            for char in word: 
                outputString += morseDic[char] + "0"
        #self.finalOutputString = "313130 "
        self.finalOutputString = self.finalOutputString + "1110101110101110000000" #initialize with 'CT' prosign to indicate the start of a message
    ...
    def work(self, input_items, output_items):
        ...
        # Idle/Waiting for repeat timer to elaps
